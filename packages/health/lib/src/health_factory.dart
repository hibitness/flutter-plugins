...
class HealthFactory {
  ...
  Future<List<HealthDataPoint>> _prepareQuery(
    ...
    return await _dataQuery(startTime, endTime, dataType, filterByResources);
  }
  ...
  /// Get total data type in interval split by day
  /// filterByResources: Only work for Android
